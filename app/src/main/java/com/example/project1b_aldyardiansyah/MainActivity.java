package com.example.project1b_aldyardiansyah;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        angka_pertama = (EditText) findViewById(R.id.et_number1);
        angka_kedua = (EditText) findViewById(R.id.et_number2);
        ...
        bersihkan = (Button) findViewById(R.id.btn_bersihkan);
